...
int main()
{
	std::cout << "Linear system solver: This program solves square matrix equations of the form Ax=b" << std::endl << std::endl;
	matrix A;
	matrix x;
	matrix b;
	matrix residual;
	...
	std::cout << "Enter the number of rows/columns:" << std::endl;
	int dimensionOfA;
	std::cin >> dimensionOfA;
	A.getMatrix(dimensionOfA, dimensionOfA);

	std::cout << "Enter details for the matrix b:" << std::endl;
	b.getMatrix(dimensionOfA, 1);
