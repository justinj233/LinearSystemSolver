...
public:
	...
	void getMatrix(); //obtains matrix from the user which is then stored in a new heap allocation

	void getMatrix(int r, int c); //obtains an rXc matrix from the user which is stored in a new heap allocation

	void getMatrix(int r, int c, float* e); //obtains an rXc matrix which will be stored at a designated memory location e
